...
/// </summary>
/// <remarks>
/// The SDK's own implementation. The coordinator has a separate one, and they are kept
/// honest by <c>protocol/conformance/schema-hash.json</c> rather than by sharing code —
/// the same mechanism that keeps the TypeScript implementation honest. Nothing here may
/// be changed without regenerating those vectors.
///
...
/// <c>map_entry</c> option set. Hashing what C# sees would mean this SDK could never
/// agree with a system written in another language.
/// </remarks>
